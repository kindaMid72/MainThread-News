...
export async function getMainPageContent(): Promise<{ latestNews: ArticleQuery[], headline: ArticleQuery[], breakingNews: ArticleQuery[], categories: any[] }> {
    try {
        ...
        */
        ...
        return {
            latestNews: latestNews as ArticleQuery[],
            headline: headline as ArticleQuery[],
            breakingNews: breakingNews as ArticleQuery[],
...
export async function getCategoriesArticles(categoryId: string) {
    try {
        const db = await dbAccess();
